...
public class InventoryFromXmlTest {
    ...
    private final Schema xsdSchema = XmlValidationSchemaProvider.buildXsdSchemaForAlpineBitsVersion("2017-10");
    private final Schema rngSchema = XmlValidationSchemaProvider.buildRngSchemaForAlpineBitsVersion("2017-10");
    ...
    public void testXml(String xmlFile, String action, XmlSchemaType xmlSchemaType, Class<Exception> exceptionClass) {
        String filename = "examples/v_2017_10/inventory/" + xmlFile;
