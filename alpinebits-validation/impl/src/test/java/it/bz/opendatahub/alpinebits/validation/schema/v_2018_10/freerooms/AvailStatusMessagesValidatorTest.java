...
import it.bz.opendatahub.alpinebits.xml.schema.v_2018_10.OTAHotelAvailNotifRQ.AvailStatusMessages;
import it.bz.opendatahub.alpinebits.xml.schema.v_2018_10.OTAHotelAvailNotifRQ.AvailStatusMessages.AvailStatusMessage;
...
public class AvailStatusMessagesValidatorTest {
    ...
    private StatusApplicationControl buildValidStatusApplicationControl() {
        ...
        statusApplicationControl.setStart(LocalDate.of(2018, 10, 1));
        statusApplicationControl.setEnd(LocalDate.of(2018, 10, 31));
