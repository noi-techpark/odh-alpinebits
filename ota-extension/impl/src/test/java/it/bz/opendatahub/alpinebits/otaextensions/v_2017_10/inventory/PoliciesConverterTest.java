...
public class PoliciesConverterTest {
    ...
    public void testToPolicies() throws JAXBException {
        String filename = "v_2017_10/Inventory-OTA_HotelDescriptiveContentNotifRQ-hotelinfo_policies.xml";
    ...
    public void testToPolicies_coverAllElementsAndAttributes() throws JAXBException {
        String filename = "v_2017_10/Inventory-OTA_HotelDescriptiveContentNotifRQ-hotelinfo_policies_cover_all.xml";
        Schema schema = XmlValidationSchemaProvider.buildRngSchemaForAlpineBitsVersion("2017-10");
        XmlToObjectConverter<OTAHotelDescriptiveContentNotifRQ> xmlConverter = new JAXBXmlToObjectConverter
                .Builder<>(OTAHotelDescriptiveContentNotifRQ.class)
                .schema(schema)
    ...
    public void testApplyPolicies() throws JAXBException, UnsupportedEncodingException {
        ...
        String expectedXmlFilename = "v_2017_10/Inventory-OTA_HotelDescriptiveContentNotifRQ-hotelinfo_policies.xml";
