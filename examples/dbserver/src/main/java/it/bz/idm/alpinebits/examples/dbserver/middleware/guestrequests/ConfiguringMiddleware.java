...
import it.bz.idm.alpinebits.examples.dbserver.middleware.guestrequests.configuration.GuestRequestsConfirmationMiddlewareBuilder;
import it.bz.idm.alpinebits.examples.dbserver.middleware.guestrequests.configuration.GuestRequestsReadMiddlewareBuilder;
...
public class ConfiguringMiddleware implements Middleware {
    ...
    private Middleware buildRoutingMiddleware() throws JAXBException {
        Router router = new DefaultRouter.Builder()
                ...
                .and()
                .supportsAction(AlpineBitsAction.GUEST_REQUESTS_READ_GUEST_REQUESTS)
                ...
                .and()
                .supportsAction(AlpineBitsAction.GUEST_REQUESTS_NOTIF_REPORT_GUEST_REQUESTS)
                .withCapabilities()
