...
public abstract class AfterHotelDescriptiveContentMapping {
    ...
    private ContactInfosConverter contactInfosConverter = ContactInfosConverter.newInstance();
    ...
    public void updateHotelDescriptiveContent(
        ...
        ContactInfosType contactInfosType = this.contactInfosConverter.toContactInfosType(alpineBitsHotelDescriptiveContent);
    ...
    public void updateOTAHotelDescriptiveContent(
        ...
        this.contactInfosConverter.applyContactInfo(
                alpineBitsHotelDescriptiveContent,
